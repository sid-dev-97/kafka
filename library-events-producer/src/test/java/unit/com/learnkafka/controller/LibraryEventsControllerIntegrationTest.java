...
public class LibraryEventsControllerIntegrationTest {
	...
	@Test
	@Timeout(5)
	void sendLibraryEvent() throws InterruptedException {
		//given
		Book book = Book.builder()
				.bookId(123)
				.bookAuthor("Sid")
				.bookName("Spring kafka demo")
				.build();
		...
		String expectedRecord = "{\"libraryEventId\":null,\"book\":{\"bookId\":123,\"bookName\":\"Spring kafka demo\",\"bookAuthor\":\"Sid\"}}";
